...
export default function Edittodo(props) {
    ...
    const {editTodo , addEditedTodo} = props;
        ...
        <>
            <div className="d-flex justify-content-between align-items-center shadow-sm border-start border-2 rounded p-3 mt-3">
                <form onSubmit={submitHandler} className="input-group my-3">
                    <input name='todoInput' value={editText} onChange={inputHandler} type="text" class="p-2 form-control" placeholder="i want to do ..." aria-label="Recipient's username" aria-describedby="button-addon2"/>
